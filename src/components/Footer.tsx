        ...
        <div className="cw-footer__grid">
          <div>
            <div className="cw-footer__brand">
              <img src={CLOUDINARY_IMAGES.logo} alt="Climewave" className="cw-footer__logo" />
              <div>
                <div className="cw-footer__brand-name">CLIME WAVE</div>
          ...
          <div>
            ...
            <div className="cw-footer__col-links">
              {NAV_LINKS.map(([href, label]) => (
                <Link key={href} href={href} className="cw-footer__link">{label}</Link>
              ))}
            </div>
          </div>
          ...
          <div>
            ...
            <div className="cw-footer__col-links">
              {SERVICES.map((s) => (
                <Link key={s} href="/services" className="cw-footer__link">{s}</Link>
              ))}
            </div>
          </div>
