import { forwardRef, type CSSProperties, type ElementType, type PointerEvent, type ReactNode } from 'react';
 ...
 * unaffected.
 */
const GlassCard = forwardRef<HTMLElement, GlassCardProps>(function GlassCard({
  as: Tag = 'div',
  interactive = false,
  strong = false,
  className = '',
  ...
  return (
    <Tag ref={ref as never} className={classes} style={style} {...rest}>
      {children}
    </Tag>
  );
});
